...
var spotifyApp = {};
var canadaTop = "37i9dQZEVXbKj23U1GF4IR";
var canadaViral = "37i9dQZEVXbKfIuOAZrk7G";
var globalTop = "37i9dQZEVXbMDoHDwVN2tF";
var globalViral = "37i9dQZEVXbLiRSasKsNU9";
// const spotifyFont = `<i class="fa fa-spotify" aria-hidden="true"></i>`
spotifyApp.albumInfo = {};
var headers = void 0;
var defaultList = canadaTop;
...
spotifyApp.chartsPlaylist = function (playlist) {
	// geting toplist by category
	...
	$.when(spotifyApp.topFifty).then(function (data) {
		var totalTrack = data.tracks.items;
		var albumId = void 0,
		    imageSrc = void 0,
		    imageSrcSplash = void 0;
		for (var i = 0; i < totalTrack.length; i++) {
			...
			var cardImage = "<div class=\"imageTile\"><img class=\"imageTile__img\" src=" + imageSrc + "></div>";
			var cardWrapper = $('<div class="imgHolder">').attr('id', "" + albumId).append(cardImage);
			...
			for (var k = 0; k < totalTrack[i].track.artists.length; k++) {
...
spotifyApp.galleryListener = function () {
	...
	$(".imgHolder").click(function (e) {
		var contentId = $(this).attr("id"); //targeting DOM ID
		...
		for (var i = 0; i < Object.keys(selectedAlbum.artists).length; i++) {
